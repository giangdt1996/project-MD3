...
public class InputMethods {
    private static final String ERROR_ALERT = "===>> Wrong format, Please try again...";
    private static final String EMPTY_ALERT = "===>> This data cannot be blank. Please try again...";
    /*========================================Input Method Start========================================*/
